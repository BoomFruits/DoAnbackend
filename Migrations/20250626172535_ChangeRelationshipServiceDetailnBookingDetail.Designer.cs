...
namespace DoAn.Migrations
{
    ...
    [Migration("20250626172535_ChangeRelationshipServiceDetailnBookingDetail")]
    partial class ChangeRelationshipServiceDetailnBookingDetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DoAn.Data.ServiceDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 2,
                            BookingId = 5,
                            BuyDate = new DateTime(2025, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            Amount = 1,
                            BookingId = 5,
                            BuyDate = new DateTime(2025, 6, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CustomerId = new Guid("3421ef41-6b25-4ac1-ac32-c3669513b3b4"),
                            Price = 210000.0,
                            ProductId = 4,
                            RoomId = 0
            ...
            modelBuilder.Entity("DoAn.Data.ServiceDetail", b =>
                {
                    ...
                    b.HasOne("DoAn.Data.BookingDetail", "BookingDetail")
                        .WithMany("ServiceDetails")
                        .HasForeignKey("BookingId", "RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
